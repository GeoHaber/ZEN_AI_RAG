...
class InjectableVoiceManager(VoiceManager):
    ...
    def generate_sine_wave(self, frequency: float = 1000, duration: float = 2.0, 
    ...
    def generate_white_noise(self, duration: float = 2.0, 
    ...
    def record_audio(self, duration: float = 3.0, device_id=None,
                    sample_rate: int = 16000, channels: int = 1,
                    auto_fallback: bool = True) -> RecordingResult:
        """
