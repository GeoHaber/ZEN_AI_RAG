...
def create_settings_dialog(on_save: Optional[Callable] = None, on_language_change: Optional[Callable] = None, on_dark_mode_change: Optional[Callable[[bool], None]] = None):
    ...
    with ui.dialog() as dialog, ui.card().classes('w-full max-w-3xl max-h-[90vh]'):
        ...
        with ui.scroll_area().classes('w-full flex-1 p-4'), ui.column().classes('w-full gap-6'):
            ...
            # ==================== LANGUAGE ====================
            with ui.expansion(locale.SETTINGS_CAT_LANGUAGE, icon='language').classes('w-full ' + Styles.CARD_BASE), ui.column().classes('w-full gap-4 p-4'):
            ...
            # ==================== APPEARANCE ====================
            with ui.expansion(locale.SETTINGS_CAT_APPEARANCE, icon='palette').classes('w-full ' + Styles.CARD_BASE), ui.column().classes('w-full gap-4 p-4'):
                # Dark Mode
            ...
            # ==================== AI MODEL ====================
            with ui.expansion(locale.SETTINGS_CAT_AI_MODEL, icon='smart_toy').classes('w-full ' + Styles.CARD_BASE), ui.column().classes('w-full gap-4 p-4'):
                # Default Model
            ...
            # ==================== EXTERNAL LLMs ====================
            with ui.expansion("External LLMs (Multi-LLM Consensus)", icon='cloud').classes('w-full ' + Styles.CARD_BASE), ui.column().classes('w-full gap-4 p-4'):
            ...
            # ==================== VOICE ====================
            with ui.expansion(locale.SETTINGS_CAT_VOICE, icon='mic').classes('w-full ' + Styles.CARD_BASE), ui.column().classes('w-full gap-4 p-4'):
                # TTS Enabled
                with ui.row().classes('w-full items-center justify-between'), ui.column().classes('gap-0'):
            ...
            # ==================== RAG ====================
            with ui.expansion(locale.SETTINGS_CAT_RAG, icon='library_books').classes('w-full ' + Styles.CARD_BASE), ui.column().classes('w-full gap-4 p-4'):
                # RAG Enabled
                with ui.row().classes('w-full items-center justify-between'), ui.column().classes('gap-0'):
            ...
            # ==================== CHAT ====================
            with ui.expansion(locale.SETTINGS_CAT_CHAT, icon='chat').classes('w-full ' + Styles.CARD_BASE), ui.column().classes('w-full gap-4 p-4'):
                # Row of switches
                with ui.row().classes('w-full items-center justify-between'), ui.column().classes('gap-0'):
            ...
            # ==================== SYSTEM ====================
            with ui.expansion(locale.SETTINGS_CAT_SYSTEM, icon='settings').classes('w-full ' + Styles.CARD_BASE), ui.column().classes('w-full gap-4 p-4'):
                # API Port
                with ui.row().classes('w-full items-center gap-4'), ui.column().classes('flex-1'):
