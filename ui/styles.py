...
class Styles:
    ...
    CHAT_BUBBLE_RAG = (
        "bg-blue-50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-500/20 text-gray-800 dark:text-gray-100"
    )
    ...
    BTN_SECONDARY = (
        "bg-gray-100 hover:bg-gray-200 text-gray-800 dark:bg-slate-800 dark:hover:bg-slate-700 dark:text-white"
    )
