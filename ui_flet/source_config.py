...
# Scanning helpers — try content_extractor first, fall back gracefully
_scan_web_state = None
_scan_folder_state = None
try:
    from content_extractor import scan_web as _scan_web_state, scan_folder as _scan_folder_state
except Exception:
    pass
...
def is_valid_url(url: str) -> bool:
    return bool(_re.match(r"https?://[^\s/$.?#].[^\s]*$", url, _re.IGNORECASE))
