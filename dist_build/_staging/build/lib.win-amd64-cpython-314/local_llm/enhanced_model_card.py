    ...
    def human_summary(self) -> str:
        ...
        if self.age_days is not None or self.freshness_rating:
            ...
            if self.freshness_rating:
                freshness_emoji = {"new": "🆕", "current": "✨", "stable": "⚙️", "dated": "📦"}.get(self.freshness_rating, "📦")
        ...
        if self.huggingface_downloads or self.popularity_tier:
            ...
            if self.huggingface_likes:
                likes_str = f"{self.huggingface_likes:,}" if self.huggingface_likes < 1_000 else f"{self.huggingface_likes/1_000:.1f}K"
            ...
            if self.popularity_tier:
                tier_emoji = {"trending": "📈", "popular": "👍", "established": "⭐", "niche": "🎯"}.get(self.popularity_tier, "📊")
