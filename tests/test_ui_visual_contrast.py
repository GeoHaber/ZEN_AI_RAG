...
ELEMENTS_LIGHT_MODE = [
    ...
    {'name': 'Icon Buttons (header)', 'bg': LIGHT_MODE['bg_primary'], 'fg': LIGHT_MODE['text_secondary'], 'type': 'icon'},

    # Hamburger menu / Drawer
    {'name': 'Drawer Background', 'bg': LIGHT_MODE['bg_primary'], 'fg': None, 'type': 'background'},
    {'name': 'Drawer Navigation Text', 'bg': LIGHT_MODE['bg_primary'], 'fg': LIGHT_MODE['text_primary'], 'type': 'text'},
    ...
    {'name': 'Attach/Voice Buttons', 'bg': LIGHT_MODE['bg_primary'], 'fg': LIGHT_MODE['text_secondary'], 'type': 'icon'},
]
...
ELEMENTS_DARK_MODE = [
    ...
    {'name': 'RAG Toggle (inactive)', 'bg': DARK_MODE['bg_secondary'], 'fg': DARK_MODE['toggle_inactive'], 'type': 'ui'},
    {'name': 'RAG Toggle (active)', 'bg': DARK_MODE['bg_secondary'], 'fg': DARK_MODE['purple_400'], 'type': 'ui'},
    {'name': 'Icon Buttons (header)', 'bg': DARK_MODE['bg_secondary'], 'fg': DARK_MODE['text_secondary'], 'type': 'icon'},

    # Hamburger menu / Drawer
    {'name': 'Drawer Background', 'bg': DARK_MODE['bg_secondary'], 'fg': None, 'type': 'background'},
    {'name': 'Drawer Navigation Text', 'bg': DARK_MODE['bg_secondary'], 'fg': DARK_MODE['text_primary'], 'type': 'text'},
    ...
    {'name': 'Attach/Voice Buttons', 'bg': DARK_MODE['bg_secondary'], 'fg': DARK_MODE['text_secondary'], 'type': 'icon'},
]
...
def run_contrast_tests():
    ...
    print("SUMMARY")
    print("=" * 80)
    print(f"Light Mode: {len(light_fail)} failures out of {len([r for r in results['light'] if r['status'] != 'SKIP'])}")
