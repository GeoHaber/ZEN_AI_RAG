...
class TestThreadSafety:
    ...
    def test_concurrent_search(self, tmp_path):
        ...
        threads = [
            threading.Thread(target=search_task, args=(f"document {i}",))
            for i in range(10)
        ]
    ...
    def test_concurrent_build_index(self, tmp_path):
        ...
        threads = [
            threading.Thread(target=build_task, args=(i,))
            for i in range(5)
        ]
...
class TestAddChunks:
    ...
    def test_add_chunks_basic(self, tmp_path):
        ...
        chunks = [
            {"url": "test1", "title": "T1", "text": "Pre-chunked content number one for testing the RAG system functionality here"},
            {"url": "test2", "title": "T2", "text": "Pre-chunked content number two for testing the RAG system integration there"},
        ]
    ...
    def test_add_chunks_deduplication(self, tmp_path):
        ...
        chunks = [
            {"url": "test1", "title": "T1", "text": "This content will be duplicated for testing the deduplication feature in RAG"},
            {"url": "test2", "title": "T2", "text": "This content will be duplicated for testing the deduplication feature in RAG"},  # Exact dup
        ]
...
class TestRAGPipeline:
    ...
    def test_chunk_documents(self, tmp_path):
        ...
        documents = [
            {"url": "http://test.com", "title": "Test", 
             "content": "The quick brown fox jumps over the lazy dog. " * 25}  # ~1125 chars
        ]
    ...
    def test_build_index(self, tmp_path):
        ...
        docs = [
            {"url": "test1", "title": "T1", 
             "content": "Hello world from Python programming language test document"},
            {"url": "test2", "title": "T2", 
