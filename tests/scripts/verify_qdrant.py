...
def test_qdrant_flow():
    ...
    docs = [
        {"content": "The capital of France is Paris. It is a major European city and a global center for art, fashion, gastronomy and culture.", "title": "Geography", "url": "geo.com"},
        {"content": "ZenAI is a high-performance RAG assistant specializing in logic, coding, and advanced knowledge retrieval using vector databases.", "title": "ZenAI Info", "url": "zen.ai"},
        {"content": "Quantum computing uses qubits to represent data, allowing for much faster processing of complex problems than classical computers.", "title": "Quantum", "url": "science.net"}
    ]
