...
class ConversationMemory:
    ...
    def get_recent_history(self, session_id: str = "default", 
                          turns: Optional[int] = None) -> List[Message]:
        """
    ...
    def build_contextual_prompt(self, user_query: str, session_id: str = "default",
