...
class HardwareProfiler:
    ...
    def get_profile() -> dict:
        ...
        profile = {"type": "CPU", "ram_gb": 8.0, "vram_mb": 0, "free_vram_mb": 0, "threads": cpu_threads}
        ...
        try:
            ...
            if sys.platform == "win32":
                ...
                if free_vram > 0:
                    ...
                    out = subprocess.check_output(
                        cmd, shell=False, text=True, stderr=subprocess.DEVNULL, timeout=3
                    ).strip()
        ...
        logger.info(
            f"[Profiler] Detected: {profile['type']} | {profile['ram_gb']}GB RAM | {profile['free_vram_mb']}MB Free VRAM | {profile['threads']} Threads"
        )
        return profile
