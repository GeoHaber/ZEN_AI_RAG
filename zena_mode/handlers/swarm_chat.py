...
class SwarmChatHandler:
    ...
    def __init__(self):
        ...
        self.arbitrator = SwarmArbitrator(
            config={"enabled": True, "size": 3, "min_experts": 1, "timeout_per_expert": 15.0}
        )
    ...
    async def handle_post_async(self, handler: BaseZenHandler) -> bool:
        ...
        try:
            ...
            # Create Request
            request = ArbitrationRequest(id=str(uuid.uuid4()), query=user_msg, task_type=TaskType.REASONING.value)
