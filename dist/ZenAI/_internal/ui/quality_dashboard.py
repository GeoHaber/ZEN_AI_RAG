    ...
    def update_view(self, report=None):
        ...
        with self.results_container:
            ...
            if len(history) > 1:
                ...
                with ui.row().classes('w-full items-center justify-center p-2 bg-gray-50 dark:bg-slate-800 rounded mb-4'):
                     ui.label(f"{emoji} Drift Analysis: {sign}{diff:.2f} performance change detected vs last run.").classes(f'text-sm font-medium {color}')
